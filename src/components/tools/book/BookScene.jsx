...
export default function BookScene({ config }) {
  ...
  useEffect(() => { if (!backTextureUrl) setBackU(null); else new THREE.TextureLoader().load(backTextureUrl, t => { t.colorSpace = THREE.SRGBColorSpace; t.flipY = false; t.needsUpdate = true; setBackU(t); }); }, [backTextureUrl]);
